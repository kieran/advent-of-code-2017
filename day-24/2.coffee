...
class Realities
  ...
  # find the longest bridges in the collection
  # and return the strongest of those
  #
  # had to expand this due to call stack size
  longest: ->
    ret = []
    len = 0
    for dim in @dims
...
log (new Realities input).longest().score
...
assert 19 is (new Realities input).longest().score
